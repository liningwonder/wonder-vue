export default {
  ...
  'login.form.mobilePhone.errMsg': '手机号不能为空',
  ...
  'login.form.registerName.placeholder': '注册姓名：',
  'login.form.registerMobilePhone.placeholder': '注册手机号：',
  ...
  'login.form.nameInput': '姓名:',
  'login.form.mobilePhoneInput': '手机号:',
  ...
  'login.main.text': '企 业 数 字 化 解 决 方 案'
}
