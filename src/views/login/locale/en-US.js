export default {
  ...
  'login.form.mobilePhone.errMsg': 'MobilePhone cannot be empty',
  ...
  'login.form.registerName.placeholder': 'Register Name: ',
  'login.form.registerMobilePhone.placeholder': 'Register MobilePhone: ',
  ...
  'login.form.nameInput': 'Name:',
  'login.form.mobilePhoneInput': 'Mobile phone:',
  ...
  'login.form.checkName': '2 to 10 Letters',
